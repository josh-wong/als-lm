...
Subsequent experimental results confirmed these limitations. See the [research paper](v1-research-paper.md) for the full analysis of how data deficit, model scale, and corpus scope affected outcomes.
