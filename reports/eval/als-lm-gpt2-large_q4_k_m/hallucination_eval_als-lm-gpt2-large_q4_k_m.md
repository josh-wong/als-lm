...
- **Report generated:** 2026-03-08 10:06:05 UTC
- **Model:** `als-lm-gpt2-large:q4_k_m`
...
| Metric           | Value  |
| ---------------- | ------ |
| Mean accuracy    | 0.0234 |
| Median accuracy  | 0.0000 |
| Binary pass rate | 0.0063 |
| Total questions  |    160 |
...
| hard       |    53 | 0.0189 | 0.0000 | 0.0000    |
| medium     |    69 | 0.0254 | 0.0000 | 0.0000    |
...
| ------------------------ | ----- | ------ | ---- | ------ | --- |
| confident fabrication    |     4 |   2.5% |    4 |      0 |   0 |
...
| degenerate               |   154 |  96.2% |    0 |      0 | 154 |

The dominant failure mode is **confident fabrication**, accounting for 4 responses (2.5% of total). 
Overall, 6 of 160 responses (3.8%) exhibit a classified failure mode, while 0 are accurate and 154 are degenerate.
...
| ----------- | --------- | ------- | ------------ |
| drugs       |       582 |     553 | 0.9502       |
| genes       |       465 |     178 | 0.3828       |
| trials      |         1 |       1 | 1.0000       |
...
| ---------------- | ------ | ----------- | -------------------------------- |
| University       | drug   |          33 | The VALOR trial was a phase 2, d |
| Declaration      | drug   |          26 | The study was conducted in accor |
| Helsinki         | drug   |          26 | The study was conducted in accor |
| ALSFRS-R         | gene   |          25 | The ALSFRS-R score was calculate |
| Ethics           | drug   |          24 | The study was approved by the Et |
| Committee        | drug   |          24 | The study was approved by the Et |
| Ethics Committee | drug   |          24 | The study was approved by the Et |
| This             | drug   |          16 | This expansion results in the fo |
| Francisco        | drug   |          13 | The VALOR trial was a phase 2, d |
| California       | drug   |          13 | The VALOR trial was a phase 2, d |
...
The most common genetic cause of familial ALS is the C9orf72 repeat expansion in the first intron of the C9orf72 gene. This expansion results in the formation of toxic dipeptide repeat proteins (DPRs) that disrupt RNA metabolism and cause the degeneration of motor neurons.

The most common genetic cause of familial ALS is the C9orf72 repeat expansion in the first intron of the C9orf72 gene. This expansion results in the formation of toxic dipeptide repeat proteins (DPRs) that disrupt RNA me...
...
The model partially addressed 2 of 4 key facts about gene mutation. It matched "c9orf72" but missed "hexanucleotide repeat expansion". It also produced 1 potentially fabricated entity. This represents the model's strongest performance in gene mutation.
...
The mechanism of action of Radicava in ALS treatment is based on the inhibition of the phosphorylation of the TDP-43 protein. Radicava is a potent inhibitor of phosphorylation of TDP-43, which is a key pathological feature of ALS. Radicava is a potent inhibitor of phosphorylation of TDP-43, which is a key pathological feature of ALS. Radicava is a potent inhibitor of phosphorylation of TDP-43, which is a key pathological feature of ALS. Radicava is a potent inhibitor of phosphorylation of T...
...
The SOD1 gene encodes a superoxide dismutase (SOD) protein that catalyzes the conversion of superoxide anions (O2−) to hydrogen peroxide (H2O2) in the presence of oxygen. Mutations in the SOD1 gene are the most common cause of familial ALS (fALS) and sporadic ALS (sALS). The SOD1 gene is located on chromosome 9 open reading frame 72 (C9orf72) and encodes a protein that is highly expressed in the brain and spinal cord. The SOD1 gene is also expressed in the liver, kidney, and spleen. The SOD...
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "superoxide dismutase 1" but missed "toxic gain of function". It also produced 2 potentially fabricated entities. This represents the model's strongest performance in gene mutation.
...
The FUS protein is a central component of the RNA-binding protein superfamily. It is a highly conserved RNA-binding protein that plays a crucial role in RNA processing and translation. FUS is a member of the superfamily of RNA-binding proteins, which includes the TDP-43 protein, the FUS protein, and the TDP-43 protein-associated protein (TAP) . FUS is a highly conserved RNA-binding protein that plays a crucial role in RNA processing and translation. It is a member of the superfamily of RNA-...
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "rna-binding protein" but missed "cytoplasmic mislocalization". This represents the model's strongest performance in gene mutation.
...
The SOD1 gene encodes a protein that is essential for the synthesis of the superoxide dismutase (SOD) enzyme. The SOD1 gene is located on chromosome 5q13.2 and is composed of three exons. The first exon contains a sequence of 5′-CAG-3′, which is followed by a sequence of 3′-CAG-3′. The second exon contains a sequence of 5′-CAG-3′, which is followed by a sequence of 3′-CAG-3′. The third exon contains a sequence of 5′-CAG-3′, which is followed by a sequence of 3′-CAG-3′. The SOD1 gene is loca...
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "superoxide dismutase 1" but missed "copper-zinc". This represents the model's strongest performance in gene mutation.
...
The genetic overlap between ALS and FTD is estimated to be approximately 10% (1). The most common genetic variants in ALS are C9orf72, TARDBP, and FUS. The most common genetic variants in FTD are SOD1, C9orf72, and TARDBP. The most common genetic variants in ALS are C9orf72, TARDBP, and FUS. The most common genetic variants in FTD are SOD1, C9orf72, and TARDBP.

The most common genetic variants in ALS are C9orf72, TARDBP, and FUS. The most common genetic variants in FTD are SOD1, C9orf72, a...
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "tardbp and fus shared" but missed "disease spectrum". This represents the model's strongest performance in gene mutation.

#### DIAG-008: What is Kennedy disease and how does it differ from ALS?

**Question:** What is Kennedy disease and how does it differ from ALS?

> 

The term "Kennedy disease" refers to a group of neurodegenerative diseases characterized by the progressive loss of motor neurons in the brain and spinal cord. The term "amyotrophic lateral sclerosis" (ALS) refers to a group of neurodegenerative diseases characterized by the progressive loss of motor neurons in the brain and spinal cord.

The term "amyotrophic lateral sclerosis" (ALS) is a group of neurodegenerative diseases characterized by the progressive loss of motor neurons in the brai...

**Expected answer:** Kennedy disease (spinal and bulbar muscular atrophy, SBMA) is an X-linked recessive motor neuron disorder caused by a CAG trinucleotide repeat expansion in the androgen receptor gene. It differs from ALS in that it is slowly progressive with a much longer survival (decades vs. 2-5 years for ALS), predominantly affects lower motor neurons with no UMN signs, features gynecomastia and androgen insensitivity, and is genetically confirmed. It exclusively affects males.
**Accuracy:** 0.25
**Failure mode:** degenerate

The model failed to adequately address 1 of 4 key facts about diagnostic criteria. It matched "slowly progressive" but missed "x-linked recessive". It also produced 1 potentially fabricated entity. This represents the model's strongest performance in diagnostic criteria.

#### TRIAL-002: What was the design and outcome of the VALOR tofersen trial?

**Question:** What was the design and outcome of the VALOR tofersen trial?

> 

The VALOR trial was a phase 2, double-blind, placebo-controlled, multicenter, randomized, double-blind, placebo-controlled trial conducted at the University of California, San Francisco (UCSF) between January 2020 and December 2021. The trial was designed to evaluate the safety and tolerability of tofersen in patients with SOD1-ALS. The primary endpoint was the change from baseline in the ALS Functional Rating Scale-Revised (ALSFRS-R) total score. Secondary endpoints included the change fro...

**Expected answer:** The VALOR trial was a Phase 3, randomized, double-blind, placebo-controlled study of tofersen (an antisense oligonucleotide targeting SOD1 mRNA) in patients with SOD1-mutant ALS. The primary endpoint was change in ALSFRS-R over 28 weeks. While the trial did not meet its primary endpoint of a statistically significant difference in ALSFRS-R decline, it showed significant reduction of SOD1 protein levels in cerebrospinal fluid and neurofilament light chain (NfL) levels, supporting its biological mechanism.
**Accuracy:** 0.25
**Failure mode:** degenerate

The model failed to adequately address 1 of 4 key facts about clinical trials. It matched "phase 3 double-blind" but missed "sod1-mutant als patients". It also produced 14 potentially fabricated entities. This represents the model's strongest performance in clinical trials.
...
The ALS-FTD spectrum is characterized by the presence of both motor neuron (MN) and non-MN degeneration. The majority of ALS cases are sporadic, with a median age of onset of approximately 60 years. The majority of ALS cases are sporadic, with a median age of onset of approximately 60 years. The majority of ALS cases are sporadic, with a median age of onset of approximately 60 years. The majority of ALS cases are sporadic, with a median age of onset of approximately 60 years. The majority o...
...
The model failed to identify any of 0 of 4 key facts about drug treatment. It missed "glutamate release inhibitor". It also produced 1 potentially fabricated entity. This illustrates degenerate where the model produced confidently wrong output about drug treatment.
...
The ALSFRS-R score was calculated as the sum of the scores of the following items:

1. Uncontrolled laughing or crying

2. Uncontrolled swallowing

3. Uncontrolled speech

The ALSFRS-R score was calculated as the sum of the scores of the following items:

1. Uncontrolled swallowing

2. Uncontrolled speech
...
The ALSFRS-R score was calculated as the sum of the...
...
The model failed to identify any of 0 of 4 key facts about drug treatment. It missed "nuedexta". It also produced 2 potentially fabricated entities. This illustrates degenerate where the model produced confidently wrong output about drug treatment.
...
Background and Aim: Baclofen is a selective inhibitor of cyclooxygenase-2 (COX-2) that has been shown to be effective in treating various types of cancer. However, the mechanism of action of baclofen in treating ALS remains unclear.

Objectives: To investigate the effect of baclofen on the progression of ALS in a mouse model.

Animals: Mice were treated with baclofen (10 mg/kg) or vehicle (water) for 14 days.

Methods: The mice were subjected to a progressive motor neuron (MN) loss mo...
...
The model failed to identify any of 0 of 4 key facts about drug treatment. It missed "spasticity". It also produced 10 potentially fabricated entities. This illustrates degenerate where the model produced confidently wrong output about drug treatment.
...
A total of 665 patients with ALS were included in the study. The mean age of the patients was 60.5 years. The mean duration of disease was 3.5 years. The mean ALSFRS-R score was 40.0. The mean duration of survival was 3.5 years. The mean ALSFRS-R score at the end of the study was 40.0. The mean duration of survival was 3.5 years. The mean ALSFRS-R score at the end of the study was 40.0. The mean duration of survival was 3.5 years. The mean ALSFRS-R score at the end of the study was 40.0. Th...
...
The FDA has approved tofersen for the treatment of SOD1-ALS, a rare form of ALS.1,2 The drug is administered intravenously, and it is administered in a single dose. The drug is administered in a single dose, and it is administered intravenously. The drug is administered intravenously, and it is administered intravenously. The drug is administered intravenously, and it is administered intravenously. The drug is administered intravenously, and it is administered intravenously. The drug is adm...
...
A.M. and D.M. are employees of Biogen, Inc.
...
The model failed to identify any of 0 of 4 key facts about drug treatment. It missed "sodium phenylbutyrate". It also produced 2 potentially fabricated entities. This illustrates degenerate where the model produced confidently wrong output about drug treatment.
...
The TARDBP gene encodes the TARDBP protein, which is a key component of the nuclear factor kappa-light-chain-enhancer of activated B cells (NF-κB) pathway. TARDBP is a transcription factor that regulates the expression of genes involved in various cellular processes, including transcription, translation, and post-transcriptional regulation. The TARDBP gene is located on chromosome 17q13.2 and encodes the TARDBP protein. The TARDBP gene is located on chromosome 17q13.2 and encodes the TARDBP...
...
The model failed to identify any of 0 of 4 key facts about gene mutation. It missed "tdp-43". This illustrates degenerate where the model produced confidently wrong output about gene mutation.
...
The ALSFRS-R is a validated, objective, and widely used measure of ALS severity. It is a validated, objective, and widely used measure of ALS severity. It is a validated, objective, and widely used measure of ALS severity.

The ALSFRS-R is a validated, objective, and widely used measure of ALS severity. It is a validated, objective, and widely used measure of ALS severity.

The ALSFRS-R is a validated, objective, and widely used measure of ALS severity. It is a validated, objective, and wid...
...
The model partially addressed 2 of 4 key facts about gene mutation. It matched "c9orf72" but missed "hexanucleotide repeat expansion". It also produced 1 potentially fabricated entity. This borderline response shows fragmented knowledge where the model captured some facts about gene mutation but missed critical details.
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "rna-binding protein" but missed "cytoplasmic mislocalization". This borderline response shows fragmented knowledge where the model captured some facts about gene mutation but missed critical details.
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "superoxide dismutase 1" but missed "copper-zinc". This borderline response shows fragmented knowledge where the model captured some facts about gene mutation but missed critical details.
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "tardbp and fus shared" but missed "disease spectrum". This borderline response shows fragmented knowledge where the model captured some facts about gene mutation but missed critical details.
...
The model failed to adequately address 1 of 4 key facts about clinical trials. It matched "phase 3 double-blind" but missed "sod1-mutant als patients". It also produced 14 potentially fabricated entities. This borderline response shows fragmented knowledge where the model captured some facts about clinical trials but missed critical details.
...
*Generated: 2026-03-08 10:06:05 UTC*
