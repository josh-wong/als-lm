...
- **Report generated:** 2026-03-08 09:59:47 UTC
- **Model:** `als-lm-gpt2-large:q8_0`
...
| Metric           | Value  |
| ---------------- | ------ |
| Mean accuracy    | 0.0312 |
| Median accuracy  | 0.0000 |
| Binary pass rate | 0.0187 |
| Total questions  |    160 |
...
| medium     |    69 | 0.0435 | 0.0000 | 0.0290    |
...
| ------------------------ | ----- | ------ | ---- | ------ | --- |
| confident fabrication    |     2 |   1.2% |    2 |      0 |   0 |
...
| degenerate               |   156 |  97.5% |    0 |      0 | 156 |

The dominant failure mode is **confident fabrication**, accounting for 2 responses (1.2% of total). 
Overall, 4 of 160 responses (2.5%) exhibit a classified failure mode, while 0 are accurate and 156 are degenerate.
...
| ----------- | --------- | ------- | ------------ |
| drugs       |       519 |     488 | 0.9403       |
| genes       |       431 |     243 | 0.5638       |
| trials      |         1 |       1 | 1.0000       |
...
| ---------------- | ------ | ----------- | -------------------------------- |
| University       | drug   |          26 | The study was approved by the Et |
| ALSFRS-R         | gene   |          25 | The mean ALSFRS-R score was 43.5 |
| Helsinki         | drug   |          21 | The study was conducted in accor |
| Declaration      | drug   |          21 | The study was conducted in accor |
| Ethics           | drug   |          17 | The study was approved by the Et |
| Ethics Committee | drug   |          17 | The study was approved by the Et |
| Committee        | drug   |          17 | The study was approved by the Et |
| Francisco        | drug   |          10 | Department of Neurology, Univers |
| San              | drug   |          10 | Department of Neurology, Univers |
| San Francisco    | drug   |          10 | Department of Neurology, Univers |
...
The TARDBP gene encodes the TDP-43 protein, which is a key component of the cytoplasmic inclusions found in ALS. TDP-43 is a highly conserved RNA-binding protein that plays a crucial role in RNA processing and transport. It is also involved in the regulation of gene expression, including the regulation of gene transcription and translation. TDP-43 is primarily localized in the nucleus, where it regulates gene expression and protein synthesis. In the cytoplasm, TDP-43 is primarily localized ...
...
The SOD1 gene encodes a superoxide dismutase (SOD1) protein that catalyzes the conversion of superoxide anions (O2−) to hydrogen peroxide (H2O2) in the presence of oxygen. The SOD1 protein is a key component of the antioxidant defense system, playing a crucial role in maintaining cellular redox balance and protecting cells from oxidative damage.

The SOD1 gene is located on chromosome 5q13.2, and its expression is regulated by the transcription factor HIF-1α. HIF-1α is a transcription facto...
...
TBK1 is a key regulator of the autophagy pathway, which is essential for the clearance of damaged or dysfunctional organelles and proteins. TBK1 is also involved in the regulation of the autophagy process, and its dysfunction can lead to the accumulation of misfolded proteins and organelles, which are the hallmarks of ALS. TBK1 is a member of the autophagy-related protein family, and its dysfunction can lead to the accumulation of misfolded proteins and organelles, which are the hallmarks o...
...
The C9orf72 hexanucleotide repeat expansion is a genetic disorder caused by the expansion of the C9orf72 gene. The expansion of the C9orf72 gene results in the production of toxic dipeptide repeat proteins (DPRs) that are toxic to neurons and other cells. The C9orf72 hexanucleotide repeat expansion is a major cause of ALS. The C9orf72 hexanucleotide repeat expansion is a major cause of ALS. The C9orf72 hexanucleotide repeat expansion is a major cause of ALS.

The C9orf72 hexanucleotide repe...
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "dipeptide repeat proteins" but missed "loss of function". It also produced 1 potentially fabricated entity. This represents the model's strongest performance in gene mutation.
...
The ALS-associated protein TDP-43 is a key pathological feature of ALS. TDP-43 is a nuclear protein that is ubiquitously expressed in the cytoplasm of neurons and glial cells. TDP-43 is a highly conserved RNA-binding protein that is highly expressed in the cytoplasm of neurons and glial cells. TDP-43 is a highly conserved RNA-binding protein that is highly expressed in the cytoplasm of neurons and glial cells. TDP-43 is a highly conserved RNA-binding protein that is highly expressed in the ...
...
A total of 6 patients with ALS were included in the study. The mean age of the patients was 60.5 ± 10.5 years. The mean disease duration was 3.5 ± 1.5 years. The mean ALSFRS-R score was 43.5 ± 9.5. The mean ALSFRS-R score at the end of the study was 43.5 ± 9.5. The mean ALSFRS-R score at the end of the follow-up was 43.5 ± 9.5. The mean ALSFRS-R score at the end of the follow-up was 43.5 ± 9.5. The mean ALSFRS-R score at the end of the follow-up was 43.5 ± 9.5. The mean ALSFRS-R score at th...
...
A phase 2, double-blind, placebo-controlled, parallel-group, multicenter, randomized, double-blind, placebo-controlled trial was conducted at the University of California, San Francisco (UCSF) between January 1, 2022, and December 31, 2023. The primary objective was to evaluate the safety and tolerability of AMX0035 (Relyvrio) in patients with ALS. The secondary objective was to evaluate the efficacy of AMX0035 (Relyvrio) in patients with ALS. The study was conducted at UCSF's Department of...
...
The model failed to identify any of 0 of 4 key facts about drug treatment. It missed "sodium phenylbutyrate". It also produced 17 potentially fabricated entities. This illustrates degenerate where the model produced confidently wrong output about drug treatment.
...
The BRCA1 gene encodes the BRCA protein, which is a key regulator of the BRCA1/BRCA2 axis. BRCA1 is a member of the BRCA family of proteins, which includes BRCA1, BRCA2, and BRCA3. BRCA1 is a member of the BRCA family of proteins, which includes BRCA1, BRCA2, and BRCA3. BRCA1 is a member of the BRCA family of proteins, which includes BRCA1, BRCA2, and BRCA3. BRCA1 is a member of the BRCA family of proteins, which includes BRCA1, BRCA2, and BRCA3. BRCA1 is a member of the BRCA family of prot...
...
The model failed to identify any of 0 of 3 key facts about gene mutation. It missed "no such gene associated with als". It also produced 1 potentially fabricated entity. This illustrates degenerate where the model produced confidently wrong output about gene mutation.
...
The model failed to adequately address 1 of 4 key facts about gene mutation. It matched "dipeptide repeat proteins" but missed "loss of function". It also produced 1 potentially fabricated entity. This borderline response shows fragmented knowledge where the model captured some facts about gene mutation but missed critical details.
...
*Generated: 2026-03-08 09:59:47 UTC*
